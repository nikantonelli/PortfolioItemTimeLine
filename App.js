...
//            gApp._renderMilestones Can't render these until we have set up the svg panels.
            ...
            success: function(results) {
                ...
                if (globalMls.length === 0 ) {
                    Rally.ui.notify.Notifier.showWarning({ message: results.length.toString() + ' Project Milestones available'});
                }
                else if (globalMls.length === results.length) {
                    Rally.ui.notify.Notifier.showWarning({ message: results.length.toString() + ' Global Milestones available'});
                }
                else {
                    Rally.ui.notify.Notifier.showWarning({ message: globalMls.length.toString() + ' Global and ' + 

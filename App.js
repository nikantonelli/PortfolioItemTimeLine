        ...
        var node = d3.select('#zoomTree').selectAll(".node")
            ...
            .enter().append("g")
                ...
                .attr( 'transform', function(d) {
                    ...
                    d.x = (x<0?0:x);
                    d.width = gApp.dateScaler(new Date(d.data.record.get('PlannedEndDate'))) - d.x;
                    d.width = d.width<0?0:d.width;
//                    if ( d.data.Name === 'F10') { debugger;}
        ...
        node.append('rect')
            .attr('rx', gApp._rowHeight/3)
            .attr('ry', gApp._rowHeight/3)
        ...
        ;
                ...
                node.append('text')
                    ...
                    .attr('x', function(d) { return d.x?(gApp._rowHeight/2):gApp._rowHeight;})
                    ...
                    .text(function(d) { return d.data.record.get('Name');});
